...
export function UnitDetailsActions({
  actions,
}: UnitDetailsActionsProps) {
  return (
    <div className="flex gap-1.5 w-full mt-auto">
      {actions.map((action, idx) => {
        ...
        if (
          ...
          className = cn(
            className,
            "flex-[1.3] bg-primary text-primary-foreground shadow-2xl shadow-primary/30 hover:scale-[1.02] active:scale-95"
          );
        } else if (
